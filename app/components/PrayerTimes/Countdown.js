...
export default function Countdown({ nextPrayer, countdown }) {
    ...
    return (
        <div
            className={`card shadow-sm border container col-11 col-sm-8 m-auto py-2 ${styles.countdownCard}`}
            dir="rtl"
        >
            <div className={`d-flex align-items-center justify-content-between gap-3 ${styles.cardContent}`}>
                ...
                <img
                    src="/hero.png"
                    alt="Prayer"
                    className={`rounded-circle  shadow ${styles.profileImage}`}
                />
                ...
                <div className={`text-center ${styles.textSection}`}>
                    ...
                    <h1 className="fw-bold mb-1">الصلاة القادمة: {nextPrayer}</h1>
