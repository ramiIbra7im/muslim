...
export default function HijriCalendar() {
            ...
            try {
                ...
                if (upcoming) {
                    setNextEvent({
                        ...
                        gregorian: upcoming.gregorian?.date || null,
                    });
                }
    ...
    return (
        <div className={`${styles.container} container-fluid py-3 min-vh-100 m-0  `}>
        ...
        `}
                ...
                <div
                    className={`${styles.islamicBanner} py-5  p-md-5  align-items-center  mt-3 rounded-4 shadow-sm`}
                >
